...
class MissingSequenceError(BatchworkError):
...
class InvalidSequenceError(BatchworkError):
    """La secuencia contiene caracteres que no son nucleotidos."""


class ChecksumMismatchError(BatchworkError):
...
class FetchError(BatchworkError):
