"""Verificador de la regla 2 de Batchwork (ver `apps/batchwork/CLAUDE.md`).
...
Uso:
    python3 apps/batchwork/tools/check_rules.py [ruta ...]

Sin rutas analiza todo `apps/batchwork/`. Codigos de salida: 0 limpio, 1 violaciones,
