...
biológicas: `tests/data/` sigue vacío a propósito (ver `tests/data/PROCEDENCIA.md`).
"""
...
class TestInformeDeViolaciones(unittest.TestCase):
    ...
    def test_violacion_indica_fichero_linea_y_motivo(self):
        ...
        violations = scan_source(source, "apps/batchwork/red.py")
        self.assertEqual(len(violations), 1)
        v = violations[0]
        self.assertEqual(v.filename, "apps/batchwork/red.py")
